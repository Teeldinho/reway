...
const multiSelectVariants = cva(
  "m-1 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 font-ptSans text-sm capitalize font-semibold tracking-wide rounded-md ",
  {
    variants: {
      variant: {
        default: "border-foreground/10 text-primary-foreground bg-primary",
                  ...
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <X
                          className="mr-2 h-4 w-4 cursor-pointer opacity-80"
                          onClick={(event) => {
