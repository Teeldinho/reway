...
export default function ProductDetailsList({ product }: ProductCardProps) {
  return (
    <>
      <h5 className="font-ptSans text-[12px] leading-[15.53px] text-rewayLightGrey uppercase">Product Details</h5>
      <ul className="w-full flex flex-col gap-1">
        {product.metadata.details.map((detail, index) => (
          <li key={index} className="flex items-center text-rewayGrey">
