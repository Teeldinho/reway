...
export default function TopBanner() {
  return (
    <div className="relative w-full h-[89px] rounded overflow-hidden">
      ...
      <div className="absolute w-full h-full flex items-center justify-between px-16 z-10">
        ...
        <Button variant={"outline"} className="absolute top-6 md:right-20 lg:right-[360px] max-w-fit text-white border-white hover:bg-white/20">
          Shop Now
        </Button>
      </div>
    </div>
